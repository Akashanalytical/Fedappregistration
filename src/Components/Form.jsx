...
import { Icon1, Icon2, Icon3 } from "./icon1";
...
const Form = () => {
  ...
  const initialSpouseDob = new Date(1690541748453);
  ...
  const formik = useFormik({
    initialValues: {
      ...
      companystate: "",
      companycity: "",
      companyaniversary: initialSpouseDob,
      usertype: "Chief",
      pincode: "",
      firstName: "",
      whatsapp: "",
      ...
      children: "",
      spousename: "",
      spousedob: initialSpouseDob,
      weddinganniversary: initialSpouseDob,
      instagaram: "",
      facebook: "",
      twitter: "",
      linkedin: "",
      ...
      activeStep === 0
        ...
        ? Yup.object().shape({
            ...
            spousedob: Yup.date().when("maritalStatus", {
              is: (value) => value === "married",
              then: () => Yup.date().required("Spouse DOB is required"),
              otherwise: () => Yup.date().nullable(),
            }),
            weddinganniversary: Yup.date().when("maritalStatus", {
              is: (value) => value === "married",
              then: () => Yup.date().required("Wedding aniversary is required"),
              otherwise: () => Yup.date(),
            }),
          })
        : Yup.object().shape({
            ...
            companycontactnumber: Yup.string().required(
              "companycontactnumber is required"
            ),
            companypincode: Yup.string().required("companypincode is required"),
            companyemailid: Yup.string().required("companyemailid is required"),
            gstnumber: Yup.string().required("companyemailid is required"),
            services: Yup.string().required("services is required"),
            companyaddress: Yup.string().required("companyaddress is required"),
            companyarea: Yup.string().required("companyaddress is required"),
            companycity: Yup.string().required("companycity is required"),
            companystate: Yup.string().required("companystate is required"),
            companyaniversary: Yup.date().required(
              "companyaniversary is required"
            ),
          }),
  ...
  const formContent = (step) => {
    switch (step) {
      ...
      case 2:
        return <FamilyInfo formik={formik} info={inputArr} />;
  ...
  return (
    <>
      ...
      >
        ...
        <Stepper
          sx={{ mr: "auto", ml: "auto", mt: 2, mb: 2, display: "flex" }}
